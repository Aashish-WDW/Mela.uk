...
import { Boxes, Map, Truck, Activity, ArrowUpRight, BarChart3, Warehouse as WarehouseIcon } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden flex flex-col">
          <div className="bg-gray-50 border-b border-gray-200 px-6 py-4 flex items-center justify-between">
             <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-amazon-dark">Thermal Bin Occupancy</span>
             </div>
             <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Zone A (Food & Bev)</span>
          </div>
            ...
            {Array.from({ length: 64 }).map((_, i) => {
              ...
              return (
                <div 
                  ...
                  style={{ background: fill > 0.8 ? '#e77600' : fill > 0.4 ? '#37475a' : '#f3f3f3' }} 
                >
          ...
          <div className="mt-auto px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-between items-center">
             <div className="flex items-center gap-4 text-[9px] font-bold text-gray-400 uppercase tracking-widest">
                <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#e77600]" /> High</div>
                <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#37475a]" /> Med</div>
                <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#f3f3f3]" /> Empty</div>
             </div>
             <button className="text-[10px] font-black text-blue-600 hover:underline uppercase tracking-widest">Full 3D Map</button>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden flex flex-col">
          <div className="bg-gray-50 border-b border-gray-200 px-6 py-4 flex items-center gap-2">
             ...
             <span className="text-[10px] font-black uppercase tracking-widest text-amazon-dark">Active Outbound Manifest</span>
          </div>
          <div className="flex-1 overflow-y-auto">
            <div className="divide-y divide-gray-100">
              {orders.map((o) => {
                ...
                return (
                  <div key={o.id} className="p-5 hover:bg-gray-50 transition-colors group cursor-pointer flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded border border-gray-100 p-0.5 bg-white flex items-center justify-center overflow-hidden shrink-0 shadow-sm">
                         <img src={b?.image} alt={o.buyerCompany} className="w-full h-full object-cover rounded-sm" />
                      </div>
                      <div>
                        <div className="text-sm font-bold text-amazon-dark group-hover:text-blue-600 transition-colors">{o.buyerCompany}</div>
                        <div className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">{o.ref} · {o.items} Units</div>
                      </div>
                    </div>
                    <div className="text-right">
                       <div className="text-[10px] font-black text-amazon-dark uppercase tracking-widest">ETA {o.eta}</div>
                       <div className="text-[10px] text-green-600 font-bold uppercase tracking-tight mt-0.5">Dispatched</div>
                    </div>
                  </div>
                );
              })}
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        <div className="bg-gray-50 border-b border-gray-200 px-6 py-4 flex items-center gap-2">
           ...
           <span className="text-[10px] font-black uppercase tracking-widest text-amazon-dark">Real-time Stock Velocity</span>
        </div>
              ...
              <div key={p.id} className="group">
                 <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                       ...
                       <span className="text-xs font-bold text-amazon-dark group-hover:text-blue-600 transition-colors">{p.name}</span>
                    </div>
