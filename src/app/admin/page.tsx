    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <StatCard
          ...
          value={stats.enquiriesMonth.toLocaleString()}
          hint="High Volume"
        />
            ...
            <div className="flex items-end gap-1.5 h-56">
              {trend.map((v, i) => (
                <div
                  ...
                  style={{
                    height: `${v * 0.8}%`,
                    background: i === trend.length - 1 ? "#e77600" : "#232f3e",
                  }}
                >
              ...
              {vendors.slice(0, 5).map((v) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-amazon-dark group-hover:text-blue-600 truncate max-w-[120px]">
                        {v.name}
                      </div>
