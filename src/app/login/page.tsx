      ...
      <div className="min-h-screen bg-white flex flex-col items-center pt-10 md:pt-16 px-4 font-sans">
        ...
        <div className="w-full max-w-[350px] mt-6 border border-gray-300 rounded-lg p-6 md:p-8 shadow-sm">
          ...
          <p className="text-sm text-gray-700 mb-8 leading-relaxed">
            Welcome back, <span className="font-bold">{user.name}</span>. You are currently managing
            your trade account.
          </p>
          <Link
            href="/catalogue"
            className="block w-full bg-amazon-orange hover:bg-amazon-orange-hover text-amazon-dark text-center py-2 rounded-full text-sm font-bold shadow-md transition-all active:scale-95"
          >
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center pt-8 md:pt-12 px-4 font-sans pb-20 overflow-x-hidden">
      ...
      <div className="w-full max-w-[350px] mt-4 border border-gray-200 rounded-lg p-6 md:p-8 shadow-sm">
        <h1 className="text-[28px] md:text-[32px] font-medium mb-5 text-gray-950">
          {mode === "signin" ? "Sign-In" : "Create Account"}
        </h1>

        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-bold block mb-1.5 text-gray-900">
          ...
          <div>
            <div className="flex justify-between items-end mb-1.5">
              ...
              <button
                type="button"
                className="text-[11px] text-blue-600 hover:underline hover:text-orange-700 font-medium"
              >
        ...
        <div className="mt-5 text-[11px] text-gray-700 leading-relaxed">
          By continuing, you agree to Mela's{" "}
          <span className="text-blue-600 hover:underline cursor-pointer font-medium">
            Trade Conditions of Use
          </span>{" "}
          and{" "}
          <span className="text-blue-600 hover:underline cursor-pointer font-medium">
            Privacy Notice
        ...
        <div className="mt-6 flex items-center gap-1.5 group cursor-pointer border-t border-gray-50 pt-5">
          ...
          <span className="text-[11px] text-blue-600 hover:underline hover:text-orange-700 font-bold uppercase tracking-wider">
            Need trade help?
          </span>
        </div>
      </div>
      ...
      <div className="w-full max-w-[350px] mt-8 flex items-center gap-3">
        ...
        <span className="text-[11px] text-gray-500 font-bold uppercase tracking-widest">
          {mode === "signin" ? "New to Mela?" : "Already Registered?"}
        </span>
        <div className="h-[1px] bg-gray-200 flex-1" />
      </div>
      ...
      <div className="w-full max-w-[350px] mt-10 p-4 bg-blue-50/50 border border-blue-100 rounded-lg flex gap-3 group hover:bg-blue-50 transition-colors">
        ...
        <div className="text-[10px] text-blue-800 leading-relaxed font-medium">
          <span className="font-bold uppercase tracking-tighter block mb-0.5">
            Sandbox Environment
          </span>
          Any trade credentials will work. This interface is optimized for procurement evaluation
          and wholesale logistics testing.
        </div>
      </div>
      ...
      <div className="mt-16 w-full max-w-[1500px] border-t border-gray-100 pt-10 flex flex-col items-center">
        ...
        <div className="text-[10px] text-gray-400 font-medium">
          © 2024-2026, Mela.uk Global Trade, Inc. or its affiliates
        </div>
      </div>
    </div>
  );
...
function Logo() {
  return (
    <Link href="/" className="flex items-center gap-0.5 mb-6 group">
      <span className="font-display text-4xl font-bold tracking-tighter text-amazon-dark group-hover:opacity-80 transition-opacity">
        mela
      </span>
