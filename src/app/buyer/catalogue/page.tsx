  ...
  return (
    <div>
      <PageHeader
        ...
        title="Browse the warehouse."
        sub="Pricing is private. Tap any product to start a call to order."
      />
      ...
      {filtered.length === 0 && (
        <div className="text-center text-muted-foreground py-20">Nothing matches that filter.</div>
      )}
    </div>
  );
}
